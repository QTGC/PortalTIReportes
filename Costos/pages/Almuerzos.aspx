<%@ Page Title="" Language="C#" MasterPageFile="~/Costos/pages/Costos.master" AutoEventWireup="true" CodeFile="Almuerzos.aspx.cs" Inherits="Costos_pages_Almuerzos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <div style="margin-left: 3%; margin-right: 3%; margin-bottom: 3%; margin-top: 2%; border-style: solid; border-width: 5px; border-color: #e2b50e; border-radius: 10px" runat="server">
            ...
            <div class="row">
                ...
                <%--                Sección de filtors para fechas--%>
...
<%--                    <div style="margin-top: 5%">
                ...
                <div class="col" style="margin-top: 1%; margin-left: 2%">
                    Desde:
                <br />
                    <asp:TextBox ID="txtFechaInicio" runat="server" ReadOnly="true" Width="150px" Style="border-radius: 5px"></asp:TextBox>
                ...
                <div class="col" style="margin-top: 1%; margin-left: 2%">
                    Hasta:   
                <br />
                    <asp:TextBox ID="TxtFechaFin" runat="server" ReadOnly="true" Width="150px" Style="border-radius: 5px"></asp:TextBox>
                    <%--<asp:ImageButton ID="ImageButton2" runat="server" Height="34px" ImageUrl="~/images/demo/calendar2.png" OnClick="ImageButton1_Click" Width="32px" Style="" />--%>
