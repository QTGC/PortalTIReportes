...
public partial class reporte : System.Web.UI.Page
{
    ...
    private void buscar2()
    {
      ...
      //  cargando("on");
       ...
       // String queryCount;
        String query;
        query = "SELECT ROW_NUMBER() OVER(ORDER BY CONVERT(DATE, I_vDOCDATE, 103) ASC) AS '#', I_vSOPNUMBE as 'Número de Doc', I_vCUSTNMBR as 'Código', isnull(stmtname, '') as 'Nombre', CHAR(39)+I_vSHRTNAME as 'Dócumento', I_vDOCDATE as 'Fecha', I_vDOCAMNT as 'Valor', I_vRCTNCCRD 'Número de Tajeta', CHAR(39)+I_vAUTHCODE 'Autorización', I_vLOCNCODE 'Ambiente', CHAR(39)+LOTE as 'Lote', CHAR(39)+VOUCHER as 'VOUCHER', ESTABLECIMIENTO, DESCRIPCION as 'Tipo de pago', DESCRIPCION_SRI as 'Descripción SRI', VALOR_IVA as 'Valor IVA' FROM QTGC.dbo.ICG_TMP_Interface_Ventas_Pagos left join[192.168.2.11].QTGC.DBO.RM00101   ON I_vCUSTNMBR = CUSTNMBR COLLATE Modern_Spanish_CI_AS  WHERE CONVERT(DATE, I_vDOCDATE, 103) >= '" + Calendar1.SelectedDate.ToString("MM/dd/yyyy") + "' and CONVERT(DATE, I_vDOCDATE, 103) <= '" + Calendar2.SelectedDate.ToString("MM/dd/yyyy") + "'";
    ...
    private void Export()
    {
        ...
        else
        {
          ...
          Response.Charset = "";
            string FileName = "Reporte_Tarjetas_" + Calendar1.SelectedDate.ToString("dd/MM/yyyy") + ".xlsx";
