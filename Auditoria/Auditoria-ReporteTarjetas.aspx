<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Auditoria-ReporteTarjetas.aspx.cs" Inherits="Auditoria_Auditoria_ReporteTarjetas" %>
    ...
    <div>
        ...
        <div style="" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-3" style="margin-top: 1%; margin-left: 2%; font-size: small">
                    ...
                    <div>
                        <asp:TextBox ID="txtNumTarjeta1" runat="server" Width="59px" Style="border-radius: 5px"></asp:TextBox>
                        XXXXX
                        <asp:TextBox ID="txtNumTarjeta2" runat="server" Width="32px" Style="border-radius: 5px"></asp:TextBox>
                    </div>
             ...
             <div class="row">
                ...
                <div class="col-3" style="margin-top: 0%; margin-left: 1%; top: 0px; left: 0px;">
                     Exportar a Excel
                    <br />
                ...
                <div id="DivGrid" runat="server" style="align-content: center; border-radius: 10px; margin-bottom: 0%; margin-left: 2%; width: 95%; overflow: auto; height: 500px; border-style: solid; border-width: 3px; border-color: #e2b50e">
